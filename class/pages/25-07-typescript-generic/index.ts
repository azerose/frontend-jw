...
// 2, any타입=> 그냥 자바스크립트와 같음

const getAny = (arg1: any, arg2: any, arg3: any): [any, any, any] => {
  return [arg3, arg2, arg1]; // any는 아무거나 다 됨
};

const result = getAny("철수", 123, true);

// 3.unknown 타입 any보다 안전함

const getUnknown = (arg1: unknown, arg2: unknown, arg3: unknown): [unknown, unknown, unknown] => {
  if (typeof arg1 === "number") console.log(arg1 + 1000); // unknown은 사용할때, 가정(if)을 사용해서 사용해야함
  return [arg3, arg2, arg1];
};

const result = getUnknown(123, false, true);
